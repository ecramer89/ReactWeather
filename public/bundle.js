...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOM = __webpack_require__(158); //we have to explicitly import the modules when we remove them from the script tags for these dependencies in index, which otherwise makes stuff globally available
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(159),
	    Link = _require.Link,
	    IndexLink = _require.IndexLink; //require('react-router') resolves to an object
	...
	var Navigation = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        Link,
	        { to: '/about', activeClass: 'active', activeStyle: { fontWeight: 'bold' } },
	        'About'
	      ),
	      _react2.default.createElement(
	        Link,
	        { to: '/examples', activeClass: 'active', activeStyle: { fontWeight: 'bold' } },
	        'Examples'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = _react2.default.createClass({
	  ...
	  handleNewCity: function handleNewCity(city) {
	    ...
	    _OpenWeatherMap2.default.getTemp(city).then(
	    ...
	    this.handleNewTemp.bind(this, city), function (err) {
	      alert(err.message);
	  ...
	  handleNewTemp: function handleNewTemp(city, temp) {
	    this.setState({ city: city, temp: temp, isLoading: false }); //will trigger an automatic call to render.
	  },
	  ...
	  render: function render() {
	    ...
	    function renderMessage() {
	      if (isLoading) {
	        ...
	        return _react2.default.createElement(_WeatherMessage2.default, { city: city, temp: temp });
	      }
	    }
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(WeatherForm, { onNewCity: this.handleNewCity }),
	      renderMessage()
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherMessage = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var message = city == '' || temp == '' ? "" : "It's " + temp + " degrees in " + city;
	    return _react2.default.createElement(
	      'div',
	      null,
	      message
...
/***/ function(module, exports, __webpack_require__) {
	...
	var axios = __webpack_require__(221); //a useful npm module for making api calls

	var OPEN_WEATHER_MAP_URL = "http://api.openweathermap.org/data/2.5/weather?appid=ad972a421a6a99a2d887b70d3a091be2&units=imperial";

	module.exports.getTemp = function getTemp(location) {
	  var encodedLocation = encodeURI(location); //encode special characters such as spaces, %, $, etc., into their URI code equivalents (e.g., %20)
	  var url = OPEN_WEATHER_MAP_URL + "&q=" + location; //cool string interpolation in es6. use the back quotws
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PLACE_HOLDER = "Enter your city";
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('textarea', { ref: 'city', defaultValue: PLACE_HOLDER }),
	        _react2.default.createElement(
	          'button',
	          null,
	          'Check weather'
