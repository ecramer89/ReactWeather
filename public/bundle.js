...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = _react2.default.createClass({
	  ...
	  handleNewTemp: function handleNewTemp(city, temp) {
	    this.setState({ city: city, temp: temp }); //will trigger an automatic call to render.
	  },
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_WeatherMessage2.default, { city: this.state.city, temp: this.state.temp })
	    );
	  }
	});
